            ...
            <div class="comparison-item">
                <div class="comparison-card">
                    ...
                    <div class="comparison-info">
                        ...
                        <p class="comparison-description">This ... poster for <span class="text-highlight">"Grey's Anatomy"</span> presents five figures... . ... the title <span class="text-highlight">"GREY'S ANATOMY,"</span> set in large, stark white, sans-serif capital letters... Above the title, the slogan <span class="text-highlight">"Life changes in a heartbeat."</span> is written in smaller font. ... information includes <span class="text-highlight">"THURSDAYS 9|8c"</span> and <span class="text-highlight">"PREMIERES SEPT 23"</span>...</p>
                    </div>
                </div>
            </div>
        </div>
