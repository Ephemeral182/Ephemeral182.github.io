...
<div class="ds-showcase-section" id="dataset-showcase">
    <div class="ds-container">
        <div class="ds-header">
            ...
            <p class="ds-subtitle">Explore the diverse datasets that power PosterCraft's innovative generation capabilities.</p>
        </div>
            ...
            <div class="ds-carousel">
                ...
                <div class="ds-item active">
                    <div class="ds-image-area">
                        ...
                        <div class="ds-image-caption">Dataset One: Cinematic Styles</div>
                    </div>
                    <div class="ds-description-area">
                        <h3>Cinematic Styles Collection</h3>
                        <p>A curated collection of high-resolution movie posters and promotional art, focusing on diverse cinematic genres and visual aesthetics. Used for training models to understand narrative composition and dramatic lighting.</p>
                    </div>
                </div>
                <!-- Dataset Item 2 -->
                <div class="ds-item">
                    <div class="ds-image-area">
                        ...
                        <div class="ds-image-caption">Dataset Two: Typographic Art</div>
                    </div>
                    <div class="ds-description-area">
                        <h3>Typographic Art & Layouts</h3>
                        <p>Features a wide array of typographic designs, from classic print to modern digital art. This dataset helps in refining text rendering, legibility, and aesthetic integration of text within posters.</p>
                    </div>
                </div>
                <!-- Dataset Item 3 -->
                <div class="ds-item">
                    <div class="ds-image-area">
                        ...
                        <div class="ds-image-caption">Dataset Three: Abstract Visuals</div>
                    </div>
                    <div class="ds-description-area">
                        <h3>Abstract & Illustrative Visuals</h3>
                        <p>Comprises abstract art, illustrations, and graphic elements. Essential for teaching models about color theory, shape language, and non-representational visual communication in poster design.</p>
                    </div>
                </div>
                <!-- Add more dataset items as needed -->
            </div>
            <div class="ds-controls">
                <button class="ds-prev">&#10094;</button>
                <button class="ds-next">&#10095;</button>
            </div>
            <div class="ds-dots">
