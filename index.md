...
<div class="service-section">
    ...
    <div class="service-card">
        <div class="service-list">
            ...
            <p><strong>Beyond Synthesis: Exploring Diffusion Priors.</strong> I leverage diffusion priors to build methods that generalize across tasks, including <strong>Restoration</strong> (DTPM, CVPR'24; AGLLDiff, AAAI'25) and <strong>Perception</strong> (GenHaze, ICCV'25; Detect Any Mirrors, CVPR'25), bridging the gap between synthesis and visual perception.</p>
