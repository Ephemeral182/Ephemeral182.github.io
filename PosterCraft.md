            ...
            <div class="ds-content-wrapper">
                ...
                <div class="ds-dataset-content" data-index="0">
                    <div class="ds-image-grid">
                        <!-- Make sure this image is correct for Text-Render-2M -->
                        <img src="/images/postercraft/refelction_data/Text-Render-2M_display.png" alt="Text-Render-2M Dataset Showcase" class="ds-showcase-image">
                    </div>
                ...
                <div class="ds-dataset-content" data-index="1">
                    <div class="ds-image-grid">
                        <!-- Make sure this image is correct for HQ-Poster-100K -->
                        <img src="/images/postercraft/refelction_data/HQ-Poster-100K_display.png" alt="HQ-Poster-100K Dataset Showcase" class="ds-showcase-image">
                    </div>
                    <div class="ds-description">
                ...
                <div class="ds-dataset-content" data-index="2">
                    <div class="ds-image-grid">
                        <!-- Make sure this image is correct for Poster-Preference-100K -->
                        <img src="/images/postercraft/refelction_data/Preference-100K_display.png" alt="Poster-Preference-100K Dataset Showcase" class="ds-showcase-image">
                    </div>
                    <div class="ds-description">
